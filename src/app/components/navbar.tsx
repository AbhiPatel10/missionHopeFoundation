...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white dark:bg-gray-900 fixed top-0 left-0 w-full z-50 shadow-md">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        {/* Navigation Links */}
        <div
          className={`${isOpen ? "absolute p-4 top-full left-0 w-full bg-white dark:bg-gray-900 shadow-md" : "hidden"
